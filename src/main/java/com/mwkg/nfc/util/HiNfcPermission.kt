 ...
 */
internal object HiNfcPermission {
     ...
     * ```
     */
    fun getMergedPermissions(vararg types: HiNfcPermissionType): Array<String> {
 ...
 */
internal enum class HiNfcPermissionType {
 ...
 */
internal object HiNfcPermissionReqCodes {
